...
#Loading, renaming, and summarizing data to create a table
...
#Creating total row to add to bottom of the table
new_row = data.frame(
...
#Combining the total row with the table 
...
#Formatting the header for the data
